...
class MessageQueueService:
    ...
    def __init__(self) -> None:
        ...
        self.template_status: dict[str, dict[str, Any]] = {}

        self.load()

    def _load_json(self, filepath: Any, default: Any | None = None) -> Any:
    ...
    def _save_json(self, filepath: Any, data: Any) -> Any:
    ...
    def save(self) -> None:
        ...
        queue_data = {"messages": self.messages, "metadata": self._get_metadata()}
        self._save_json(self.queue_file, queue_data)

        # Save fingerprints with metadata
        fingerprints_data = {
            "fingerprints": self.fingerprints,
            "metadata": {"total_appointments": len(self.fingerprints), "last_cleanup": datetime.now().isoformat()},
        }
    ...
    def add_message(self, message_data: Any) -> None:
        ...
        if not self._is_smart_messaging_enabled():
            ...
            logger.debug("Smart messaging is disabled globally, skipping message")
    ...
    def _is_smart_messaging_enabled(self) -> Any:
        """Check if smart messaging is globally enabled"""
        try:
    ...
    def _is_preview_mode_enabled(self) -> Any:
        """Check if preview mode is enabled"""
        try:
            from storage.persistent_storage import APP_SETTINGS_FILE
    ...
    def _is_template_enabled_for_service(self, service_id: Any, template_id: Any) -> Any:
    ...
    def _add_to_preview_queue(self, message_data: Any) -> None:
    ...
    def update_message_status(self, message_id: Any, status: Any, error: Any | None = None) -> Any:
    ...
    def cancel_messages_for_appointment(self, appointment_id: Any) -> Any:
    ...
    def generate_fingerprint(self, appointment: Any) -> Any:
    ...
    def has_appointment_changed(self, apt_id: Any, new_fingerprint: Any) -> Any:
    ...
    def update_fingerprint(self, apt_id: Any, fingerprint: Any, appointment_data: Any, message_ids: Any) -> None:
    ...
    def cleanup_old_messages(self, days: Any = 7) -> Any:
    ...
    def is_template_active(self, template_id: Any) -> Any:
        """Check if a template is active"""
        return self.template_status.get(template_id, {}).get("active", True)

    def set_template_active(self, template_id: Any, active: Any) -> Any:
        ...
        return {"template_id": template_id, "active": active, "messages_affected": count if "count" in locals() else 0}

    def _deactivate_template_messages(self, template_id: Any) -> Any:
    ...
    def _reactivate_template_messages(self, template_id: Any) -> Any:
    ...
    def get_template_status(self) -> Any:
        """Get all template activation statuses"""
        return self.template_status

    def get_messages_by_template(self, template_id: Any) -> Any:
        """Get all messages for a specific template"""
        messages = []
        for _msg_id, msg_data in self.messages.items():
            msg_template = msg_data.get("template_id", msg_data.get("message_type"))
