...
def provision_first_admin(
    *,
    ...
    """
    from services.team.role_assignment import is_platform_owner_role
...
def provision_platform_owner(
    *,
    ...
    from services.dashboard.platform_portal_hosts import PLATFORM_OWNER_TENANT_ID
    from services.team.role_assignment import PLATFORM_OWNER_CREATED_BY, PLATFORM_OWNER_ROLE
