...
class MobileRefreshTokenService:
    ...
    def issue(
        ...
        *,
        ...
        if auth_tokens_use_postgres():
            from services.auth.auth_token_pg_store import mobile_issue
    ...
    def consume(self, raw: str) -> MobileRefreshRecord | None:
        ...
        if auth_tokens_use_postgres():
            from services.auth.auth_token_pg_store import mobile_delete, mobile_get, mobile_revoke
    ...
    def revoke_all_for_user(self, user_id: str) -> int:
        if auth_tokens_use_postgres():
            from services.auth.auth_token_pg_store import mobile_revoke_all_for_user
