...
class TrainingModeManager:
    ...
    def __init__(self) -> None:
        ...
        self.training_sessions: dict[str, dict[str, Any]] = {}  # user_id -> training state
        self.admin_numbers = [
    ...
    def activate_training(self, user_id: str) -> dict:
        ...
        self.training_sessions[user_id] = {"state": "waiting_qa", "started_at": datetime.now().isoformat()}
...
للإلغاء اكتب: **إلغاء** أو **Cancel**""",
            ...
            if message.lower() in ["تأكيد", "confirm", "yes", "نعم"]:
                ...
                qa_entry = {
                    ...
                    "ar": {"question": session["original_q"], "answer": session["rewritten_a"]},
                ...
                del self.training_sessions[user_id]
                return {"success": True, "message": "❌ تم إلغاء التدريب.\n\nTraining cancelled."}
    ...
    def _parse_qa(self, message: str) -> tuple[str, str] | None:
        """Parse Q&A from message"""
