...
def _build_article_upsert(
    *,
    ...
    from services.ai_setup.schemas import ArticleRecord
...
def _build_faq_upsert(
    *,
    ...
    from services.ai_setup.schemas import FaqRecord
...
async def tool_propose_cm_article_upsert(
    *,
    ...
    from services.owner_copilot.cm_approval import cm_patch_proposal_store, reject_cm_patch
