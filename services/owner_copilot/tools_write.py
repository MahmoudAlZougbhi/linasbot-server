...
async def tool_propose_cm_patch(
    *,
    ...
    from services.owner_copilot.cm_approval import propose_cm_patch, reject_cm_patch
    ...
    return ToolResult(
        ...
        error="Owner confirmation required before CM draft is saved (Approve bar or confirm_tool).",
    )
