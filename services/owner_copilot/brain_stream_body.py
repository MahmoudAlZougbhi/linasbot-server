"""Owner copilot streaming body (split from brain.py for line limit)."""
...
from services.owner_copilot.provider import iter_sol_text_deltas, iter_sol_tool_round
from services.owner_copilot.tool_dispatch import dispatch_v2_tool, tool_result_for_model

CancelCheck = Callable[[], bool]
MAX_TOOL_ROUNDS = 10


async def _iter_owner_turn_v2_events_body(
    *,
    tenant_id: str,
    user_id: str,
    role: str,
    ...
    if choice_id and choice_set_id:
        from services.owner_copilot.choices import resolve_choice
