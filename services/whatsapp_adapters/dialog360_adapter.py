...
class Dialog360Adapter(WhatsAppAdapter):
    ...
    async def send_image_message(self, to_number: str, image_url: str, caption: str | None = None) -> dict[str, Any]:
        ...
        url = f"{self.base_url}/messages"
        payload: dict[str, Any] = {"to": to_number, "type": "image", "image": {"link": image_url}}
            ...
            if "messages" in webhook_data:
                for message in webhook_data["messages"]:
                    return {
                        ...
                        "user_name": webhook_data.get("contacts", [{}])[0]
                        .get("profile", {})
