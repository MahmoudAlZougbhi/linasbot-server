...
from services.integrations.web_chat.appearance import normalize_appearance, normalize_integration_mode
from services.integrations.web_chat.config_models import (
    WebChatInstallation,
    WebChatWidgetConfig,
    config_from_raw,
    config_to_raw,
...
from services.integrations.web_chat.ha_repository import (
    HaMessage,
    HaVisitorSession,
    WebChatHaRepository,
...
from services.integrations.web_chat.store_types import WebChatMessage, WebChatVisitorSession
