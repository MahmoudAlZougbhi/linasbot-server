...
from services.integrations.web_chat.config_models import WebChatWidgetConfig, config_to_raw
from services.integrations.web_chat.delivery_outbox import ack_pending_messages, poll_pending_messages
from services.integrations.web_chat.flags import assert_widget_operational, web_chat_containment_active
from services.integrations.web_chat.processor import (
    WebChatError,
    default_greeting,
...
from services.integrations.web_chat.session_authority import SessionAuthorityError, issue_session_authority
...
async def send_visitor_message(
    *,
    ...
    from services.integrations.web_chat.session_authority import verify_session_binding
