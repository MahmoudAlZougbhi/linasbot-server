...
from services.integrations.web_chat.operation import WebChatOperationRepository, build_turn_payload
...
def test_operation_resume_after_expired_reply_ready_lease(tmp_path: Path) -> None:
    ...
    from services.integrations.web_chat.operation import _get_row
