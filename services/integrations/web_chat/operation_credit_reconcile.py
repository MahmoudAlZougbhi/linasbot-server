...
from services.integrations.web_chat.operation_fsm import OperationFsmError, OperationRecord, OperationState
...
def _reclaim_released_attempt(runtime: OperationRuntime) -> OperationRecord:
    from services.integrations.web_chat.operation import _get_row, _row_to_record
    from services.integrations.web_chat.operation_lease import handoff_lease
...
def _reset_credit_for_reclaimed_attempt(credit: Any, *, record: OperationRecord) -> None:
    from services.integrations.web_chat.credit_fsm import CreditFsmState
...
def list_release_pending_operations(*, tenant_id: str | None = None, limit: int = 50) -> list[OperationRecord]:
    ...
    from services.integrations.web_chat.operation import _row_to_record
