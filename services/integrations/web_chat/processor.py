...
from services.integrations.web_chat.constants import CHANNEL_ID, SOURCE_CHANNEL_WEB_CHAT, USER_ID_PREFIX
from services.integrations.web_chat.credit_fsm import CreditFsmState, WebChatCreditHandle, tenant_scoped_user_data
from services.integrations.web_chat.eligibility import evaluate_web_ai_eligibility
...
async def process_web_chat_message(
    *,
    ...
    from services.integrations.web_chat.operation_credit_reconcile import reconcile_credit_before_side_effects
    from services.integrations.web_chat.operation_fsm import web_chat_credit_request_id
    ...
    if runtime.record is not None and runtime.record.state == OperationState.CAPTURED:
        ...
        if replay:
            ...
            from services.integrations.web_chat.processor_completion import complete_web_chat_turn
