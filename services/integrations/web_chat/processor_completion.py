...
from services.integrations.web_chat.processor_turn_finalize import (
    complete_captured_turn,
    replay_complete_with_turn_repair,
)
from services.integrations.web_chat.store import WebChatStoreBackend, WebChatWidgetConfig
...
def _schedule_turn_followup(
    *,
    ...
    try:
        ...
        from services.integrations.web_chat.followup import maybe_schedule_web_followup_after_ai_reply
