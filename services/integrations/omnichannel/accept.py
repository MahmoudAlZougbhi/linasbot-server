...
from services.integrations.omnichannel.queues import logical_for_channel
from services.integrations.omnichannel.store import accept_inbound
...
def enqueue_deliver_job(
    *,
    ...
    from services.integrations.omnichannel.enqueue import AMBIGUOUS_ENQUEUE, enqueue_job
    from services.integrations.omnichannel.queues import outbound_logical
