...
from services.integrations.omnichannel.store import conversation_has_earlier_unfinished, persist_outbound
...
async def _generate_canonical(
    *,
    ...
    if channel == "tiktok" and surface == "dm":
        from services.integrations.omnichannel.gates import tiktok_dm_live_allowed
    ...
    if surface == "comment":
        ...
        author_id = str(payload.get("author_id") or payload.get("author_user_id") or "")
        thread = comment_conversation_id(
            tenant_id=tenant_id,
