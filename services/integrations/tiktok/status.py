...
from services.integrations.tiktok.scopes import comments_manage_ready, comments_read_ready, messaging_send_ready
...
def tiktok_integration_row(tenant_id: str) -> dict[str, Any]:
    ...
    if not settings.configured:
        ...
        from services.integrations.tiktok.status_enhanced import enhanced_status_block
