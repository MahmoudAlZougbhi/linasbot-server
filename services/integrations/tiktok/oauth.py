...
async def complete_tiktok_oauth(
    *, state: str, code: str | None, error: str | None, error_description: str | None
    ...
    try:
        from services.integrations.tiktok.toggles import enable_tiktok_comments_after_connect
...
async def disconnect_tiktok(*, tenant_id: str, actor_user_id: str) -> None:
    with whatsapp_session() as session:
        ...
        if ads_token:
            try:
                from services.integrations.tiktok.ads_oauth import revoke_ads_access_token
