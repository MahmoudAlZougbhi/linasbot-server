...
from services.integrations.tiktok.config import MAX_COMMENT_PAGES_PER_VIDEO, MAX_VIDEOS_PER_SYNC
...
from services.integrations.tiktok.scopes import comments_read_ready
...
async def _list_videos(*, access_token: str, open_id: str) -> dict[str, Any]:
    params: dict[str, Any] = {
        "business_id": open_id,
        "fields": ('["item_id","caption","thumbnail_url","share_url","embed_url","video_duration","create_time"]'),
