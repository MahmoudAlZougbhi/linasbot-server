...
from services.integrations.meta.meta_outbound_purposes import ALLOWED_PURPOSES as _ALLOWED_PURPOSES
from services.integrations.meta.meta_outbound_purposes import MetaOutboundPurpose
