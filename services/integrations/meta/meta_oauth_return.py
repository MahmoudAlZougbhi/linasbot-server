...
from services.integrations.meta.meta_app_registry import MetaAppRegistry, MetaOAuthStateError, get_meta_app_registry
...
def mobile_oauth_failure_reason(exc: BaseException) -> str:
    ...
    from services.integrations.meta.meta_app_registry_common import MetaBindingConflictError, MetaRegistryError
