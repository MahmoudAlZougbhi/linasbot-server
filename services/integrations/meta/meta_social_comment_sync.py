...
from services.integrations.meta.meta_graph_routing import build_messaging_settings_for_binding, graph_api_url
        ...
        for media in rows:
            ...
            for raw in comments[:_MAX_COMMENTS_PER_POST]:
                ...
                if username and username.casefold() == str(binding.instagram_username or "").casefold():
                    continue
                from services.integrations.meta.meta_comment_events import _stable_instagram_username_author_id
