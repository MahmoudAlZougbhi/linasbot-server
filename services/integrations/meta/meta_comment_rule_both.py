...
def is_deterministic_comment_and_dm(rule_decision: Any) -> TypeGuard[CommentRuleDecision]:
    from services.integrations.meta.meta_comment_rule_modes import is_static_both_comment
...
async def _guarded_public_reply(
    *,
    ...
    from services.integrations.meta.meta_comment_replies import _graph_post_form, _provider_rejection_is_definitive
...
async def _guarded_private_dm(
    *,
    ...
    from services.integrations.meta.meta_comment_replies import _provider_rejection_is_definitive
