...
from services.integrations.meta.meta_page_subscription_transaction import reconcile_page_activation_after_exception
    ...
    with subject_guard:
        try:
            ...
            if any(binding.channel == "facebook" for binding in staged):
                from services.integrations.meta.meta_app_webhook_subscription import (
                    ensure_app_page_webhook_subscription,
                )
