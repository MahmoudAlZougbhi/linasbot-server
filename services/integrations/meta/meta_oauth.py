...
AES-GCM encrypted credential through :mod:`services.integrations.meta.meta_app_registry`.
...
from services.integrations.meta.meta_oauth_graph import (  # noqa: F401 — re-export Graph helpers for meta_* consumers
    META_GRAPH_BASE_URL,
    MetaOAuthError,
    _debug_token,
    _eligible_pages,
