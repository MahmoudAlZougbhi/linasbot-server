...
from services.integrations.meta.meta_app_registry_backend import MetaRegistryBackend, resolve_meta_registry_backend
from services.integrations.meta.meta_app_registry_common import (
...
class MetaAppRegistryBindingsMixin:
    ...
    def _read_unlocked(self) -> dict[str, Any]:
        from services.integrations.meta.meta_app_registry_pg_store import load_state, state_fingerprint
    ...
    def _write_unlocked(self, state: dict[str, Any]) -> None:
        from services.integrations.meta.meta_app_registry_pg_store import save_state
    ...
    def _append_audit(self, event: dict[str, Any]) -> None:
        from services.integrations.meta.meta_app_registry_pg_store import append_audit_event
