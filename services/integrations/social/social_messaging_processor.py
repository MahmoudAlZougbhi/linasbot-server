...
from services.integrations.social.social_customer_name import (
    resolve_social_customer_display_name as _resolve_social_customer_display_name,
)
from services.integrations.social.social_delayed_wait import await_delayed_processing as _await_delayed_processing
...
async def process_meta_social_event(
    ...
    *,
    ...
    try:
        ...
        from services.brain.ai_reply.ai_reply_turn_runtime import reset_turn_runtime_state
        ...
        from services.integrations.social.social_turn_outcome import deferred_combine_outcome, finalize_social_turn
