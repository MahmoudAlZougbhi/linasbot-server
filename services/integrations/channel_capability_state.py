...
from services.integrations.channel_capability_status import (
...
def capability_state(tenant_id: str, platform: str, capability: CapabilityKey) -> dict[str, Any]:
    ...
    if platform_key not in _CHANNEL_ACTION_IDS:
        return empty_capability_state(capability, platform_key, checked_at)
    ...
    status, blocker_code, blocker_message = status_and_blocker(
