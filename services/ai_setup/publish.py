...
Guarded by :func:`services.ai_setup.publish_gate.ensure_publish_enabled` (hard-403 upstream in
...
async def publish_draft(
    *,
    ...
    Caller MUST have already checked :func:`services.ai_setup.publish_gate.ensure_publish_enabled`.
...
async def publish_draft_sections(
    *,
    ...
    try:
        ...
        from services.brain.search.index_status import resolve_health, set_index_status
