...
from services.ai_setup.query_interpreter import BOOKING_INTENT_RE, HUMAN_INTENT_RE, InterpretedQuery, interpret_query
from services.ai_setup.response_validator import ValidationResult, validate_response
...
async def prepare_response(
    *,
    ...
    if tiered_match:
        ...
        from services.faq.faq_answer_localize import localize_faq_answer
    ...
    try:
        ...
        from services.ai_setup.pricing.engine import compute_quote, quote_to_answer_facts
        from services.ai_setup.pricing.schemas import PricingContext, QuoteRequestLine
        from services.ai_setup.pricing.section import (
