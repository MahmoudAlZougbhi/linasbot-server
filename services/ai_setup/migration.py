...
from services.ai_setup.atomic_io import atomic_write_bytes
...
from services.ai_setup.paths import archive_dir, ensure_cm_dirs
...
def _migrate_knowledge_and_care(
    *,
    ...
    for entry in knowledge_files:
        ...
        from services.ai_setup.section_classifier import classify_article
