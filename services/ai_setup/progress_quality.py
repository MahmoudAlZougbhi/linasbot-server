...
def assess_section_fill(
    ...
    *,
    ...
    if name == "ai_basics":
        ...
        from services.ai_setup.greeting_rules import greeting_rule_has_text, greeting_rule_trigger_ok
        ...
        from services.ai_setup.branch_schedule import branches_section_has_unified_schedule
