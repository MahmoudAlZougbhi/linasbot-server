...
OWNER_V2_CORE_TOOL_SCHEMAS: list[dict[str, Any]] = [{'type': 'function',
  'function': {'name': 'help',
               'description': 'Retrieve Linas product capability help for a query.',
               'parameters': {'type': 'object', 'properties': {'query': {'type': 'string'}}}}},
 {'type': 'function',
  'function': {'name': 'read_account_summary',
               'description': 'Read setup stage, CM completeness, integrations, plan, wallet '
                              'brief.',
               'parameters': {'type': 'object', 'properties': {}}}},
 {'type': 'function',
  'function': {'name': 'read_profile',
               'description': 'Read owner profile (display name, language, address).',
               'parameters': {'type': 'object', 'properties': {}}}},
 {'type': 'function',
  'function': {'name': 'read_cm',
               'description': 'Read Content Management draft/live snapshot for a section or '
                              'overview.',
               'parameters': {'type': 'object', 'properties': {'section': {'type': 'string'}}}}},
 {'type': 'function',
  'function': {'name': 'read_usage',
               'description': 'Read usage and credit wallet snapshot.',
               'parameters': {'type': 'object', 'properties': {}}}},
 {'type': 'function',
  'function': {'name': 'read_subscription',
               'description': 'Read subscription/plan entitlements.',
               'parameters': {'type': 'object', 'properties': {}}}},
 {'type': 'function',
  'function': {'name': 'read_integrations',
               'description': 'Read Instagram/Facebook connection and health metadata (read-only).',
               'parameters': {'type': 'object', 'properties': {}}}},
 {'type': 'function',
  'function': {'name': 'diagnose_meta_health',
               'description': 'Evidence-based consolidated IG/FB diagnosis (read-only; no Meta '
                              'mutations).',
 ...
 {'type': 'function',
  'function': {'name': 'propose_diagnosis_fix',
               ...
               'parameters': {'type': 'object',
                              ...
                              'required': ['trace_id']}}},
 {'type': 'function',
  'function': {'name': 'read_faq_quota',
               'description': 'Read Smart Answers / FAQ quota.',
               'parameters': {'type': 'object', 'properties': {}}}},
 {'type': 'function',
  'function': {'name': 'propose_smart_answer',
 ...
 {'type': 'function',
  'function': {'name': 'update_profile',
               'description': 'Update owner profile fields (display_name, preferred_language, '
                              'gender, form_of_address).',
               'parameters': {'type': 'object',
