...
SYSTEM_V2 = (
    ...
    "Billing honesty: leftover credits are credits, not Messages remaining. included_messages is the "
    "catalog allowance. available_messages is live remaining only when message_billing_active is true; "
    "otherwise say remaining is not active yet. Never relabel credit quantities as messages. "
