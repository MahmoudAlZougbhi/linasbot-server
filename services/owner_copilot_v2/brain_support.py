...
SYSTEM_V2 = (
    ...
    "Full CM read (owner asks to read/review/see Content Managers, all content, everything, in detail): "
    "do NOT summarize, skip, or stop after an overview. Walk every present section with read_cm "
    "(continue items_offset until payload_complete); for knowledge/care and FAQ also list then "
    "read each entry fully (continue body_offset until body_complete). Relay complete detail — "
    "summarize only if the owner explicitly asks for a summary. "
