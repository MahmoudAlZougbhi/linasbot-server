...
OWNER_V2_CM_TOOL_SCHEMAS: list[dict[str, Any]] = [{'type': 'function',
  'function': {'name': 'inspect_cm_guide',
               ...
               'parameters': {'type': 'object',
                              'properties': {'section': {'type': 'string',
                                                         'description': 'Optional CM section id '
                                                                        '(e.g. ai_basics, faq). '
                                                                        'Omit for full overview.'},
                                             'include_guides': {'type': 'boolean',
                                                                'description': 'Include compact '
                                                                               'per-section '
                                                                               'purpose index '
                                                                               '(default true on '
                                                                               'overview).'}}}}},
 {'type': 'function',
  'function': {'name': 'cm_fill_plan',
               ...
               'parameters': {'type': 'object',
                              'properties': {'action': {'type': 'string',
                                                        'enum': ['start',
                                                                 ...
                                                                 'cancel']},
                                             'section': {'type': 'string',
                                                         'description': 'Optional section id for '
                                                                        'skip.'}}}}},
 {'type': 'function',
  'function': {'name': 'list_cm_articles',
 ...
 {'type': 'function',
  'function': {'name': 'ingest_business_dump',
 ...
 {'type': 'function',
  'function': {'name': 'validate_cm',
               'description': 'Validate current CM draft.',
               'parameters': {'type': 'object', 'properties': {}}}},
 {'type': 'function',
  'function': {'name': 'propose_cm_patch',
 ...
 {'type': 'function',
  'function': {'name': 'propose_cm_article_upsert',
 ...
 {'type': 'function',
  'function': {'name': 'propose_cm_faq_upsert',
               'description': 'Propose create/update of one FAQ group in CM. Does not write until '
                              'owner confirms via approve_cm_patch. For simple new Q&A pairs, '
                              'propose_smart_answer is also fine.',
               'parameters': {'type': 'object',
                              'properties': {'faq': {'type': 'object',
                                                     'properties': {'qa_group_id': {'type': 'string'},
                                                                    'variants': {'type': 'array'},
                                                                    'status': {'type': 'string'},
                                                                    'tags': {'type': 'array',
                              ...
                              'required': ['faq']}}},
 {'type': 'function',
  'function': {'name': 'publish_cm',
               'description': 'Request publish of validated CM (high-impact; requires '
                              'confirmation).',
               'parameters': {'type': 'object', 'properties': {}}}},
 {'type': 'function',
  'function': {'name': 'setup_next_step',
               'description': 'Advance or inspect first-run setup inside the same owner chat (same '
                              'CM draft).',
               'parameters': {'type': 'object',
                              'properties': {'action': {'type': 'string',
                                                        'enum': ['status',
                                             ...
                                             'section': {'type': 'string'}}}}},
 {'type': 'function',
  'function': {'name': 'extract_price_list',
               'description': 'Analyze an uploaded price-list attachment and return structured '
                              'extraction (no CM write).',
               'parameters': {'type': 'object',
