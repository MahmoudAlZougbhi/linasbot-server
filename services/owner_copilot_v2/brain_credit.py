"""Credit gate wrapper for owner V2 turn events (line-limit split from brain.py)."""
...
async def iter_owner_turn_v2_events(
    *,
    ...
    try:
        from services.owner_copilot_v2.brain import _iter_owner_turn_v2_events_body
