            ...
            "items": [
                {
                    ...
                    "phone": "+9614111000",
                    "status": "active",
                    "ai_search_description": "antelias branch phone",
                },
                {
                    "id": "verdun",
                    "title": "Verdun",
                    ...
                    "phone": "+9614222000",
                    "status": "active",
                    "ai_search_description": "verdun branch phone",
                },
            ]
        },
        "opening_hours": {
...
def retrieval_eval_cases() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {"id": "hours", "q": "opening hours Antelias", "relevant": {"antelias_hours"}, "families": {"hours"}},
        ...
        {"id": "product_fr", "q": "politique de remboursement", "relevant": {"refund_policy"}, "families": {"knowledge"}},
