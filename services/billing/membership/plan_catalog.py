...
from services.billing.membership.units import MICRO_USD_PER_USD, credits_to_millicredits
...
def topup_pack_matrix() -> list[dict[str, Any]]:
    from services.billing.membership.units import topup_usd_to_purchased_millicredits
