...
def _brain_imports() -> dict[str, bool]:
    names = {
        "runtime": "services.brain.runtime",
        "billing": "services.brain.billing",
        "history": "services.brain.history",
        "planner": "services.brain.planner.heuristic",
        "comments": "services.brain.comments.pipeline",
        "pending_settlement": "services.billing.membership.pending_settlement",
        "cost_dashboard": "services.billing.membership.cost_dashboard",
        "outbox": "services.brain.outbox",
        "outbox_pg": "services.brain.outbox_pg",
        "conversation_store_pg": "services.brain.conversation_store_pg",
        "leftover_reserve": "services.brain.leftover_reserve",
        "credit_reservation_index": "services.billing.membership.credit_reservation_index",
        "credit_reservation_index_pg": "services.billing.membership.credit_reservation_index_pg",
        "credit_reservation_scan": "services.billing.membership.credit_reservation_scan",
        "catalog_admin_pg": "services.billing.membership.catalog_admin_pg",
        "daily_edits": "services.billing.membership.daily_edits",
        "processing_budgets_pg": "services.billing.membership.processing_budgets_pg",
...
def _offer_blockers() -> list[str]:
    ...
    from services.billing.membership.catalog_admin import current_catalog, payment_readiness
...
def activation_readiness() -> dict[str, Any]:
    ...
    from services.billing.membership.credit_reservation_index import open_counts as leftover_credit_counts
    from services.billing.membership.pending_settlement import pending_counts
    from services.brain.outbox import outbox_counts
