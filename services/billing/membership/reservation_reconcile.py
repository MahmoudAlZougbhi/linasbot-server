...
def watch_stale_message_reservations(
    *,
    ...
    from services.billing.membership.message_ledger import list_stale_reserved
...
def watch_stale_legacy_credits(*, limit: int = DEFAULT_BATCH, max_age_seconds: int = ACTIVE_MAX_AGE_SECONDS) -> int:
    from services.billing.membership.credit_reservation_index import list_stale_open, seed_from_pending_settlements
...
def hold_failed_capture_after_send(
    *,
    ...
    from services.brain.outbox import acknowledge_pending_settlement
