    ...
    *,
    ...
    with optional_message_session() as session:
        if session is not None:
            from services.billing.membership.expense_journal_pg import pg_record, table_ready
...
def list_events(
    *,
    ...
    with optional_message_session() as session:
        if session is not None:
            from services.billing.membership.expense_journal_pg import pg_list, table_ready
