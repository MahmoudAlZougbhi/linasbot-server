...
class DynamicModelSelector:
    ...
    def analyze_complexity(self, question: str, context: list | None = None) -> QuestionComplexity:
        """
    ...
    def select_model(
        self, question: str, context: list | None = None, force_best: bool = False, user_tier: str = "standard"
...
def select_optimal_model(
    question: str, context: list | None = None, user_tier: str = "standard"
) -> tuple[str, dict[str, Any]]:
    """
...
if __name__ == "__main__":
    ...
    for question, _expected_lang in test_questions:
