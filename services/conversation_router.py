...
HUMAN_REQUEST_PATTERNS, HUMAN_REQUEST_RE, HUMAN_REQUEST_KEYWORDS, GENDER_MALE_PATTERNS, GENDER_FEMALE_PATTERNS, GREETING_ONLY_PATTERNS, GREETING_RE, SERVICE_PRICING_BOOKING_KEYWORDS, VAGUE_CLARIFICATION_PATTERNS, VAGUE_RE, SERVICE_INTENT_KEYWORDS, TATTOO_KEYWORDS, BOOKING_OR_PRICE_KEYWORDS
)
