...
async def process_training_request_with_gpt(
    ...
    if is_summary_qa_request:
        ...
        system_instruction_for_training_mode_gpt = (
            "أنت مساعد تدريب ذكي ومرن لهذا العمل. مهمتك هي التفاعل مع المدرب لفهم طلباته حول إنشاء أو تعديل بيانات تدريب (أسئلة وأجوبة). "
            ...
            "**الأسلوب:** كن ودوداً جداً، متفهماً، ومرناً. أظهر قدرة عالية على التكيف والاستجابة لاحتياجات المدرب. لا ترفض أي طلب إذا كان منطقياً. اتبع الأسلوب المنشور في AI Setup فقط."
