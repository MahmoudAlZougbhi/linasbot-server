...
from services.tenant_runtime.tenant_runtime_config_backend import (
    require_tenant_runtime_config_postgres,
    tenant_runtime_config_postgres_required,
)
from services.tenant_runtime.tenant_runtime_config_pg_store import (
...
def save_draft_envelope(
    *,
    ...
    from services.tenant_runtime.tenant_runtime_config_cache import write_draft_cache
    ...
    *,
    ...
    with whatsapp_session() as session:
        ...
        try:
            ...
            raise TenantRuntimeConfigConflictError(str(exc)) from exc
    from services.tenant_runtime.tenant_runtime_config_cache import write_comment_settings_cache
...
def save_sync_cursor(
    *,
    ...
    require_tenant_runtime_config_postgres()
    with whatsapp_session() as session:
        from services.tenant_runtime.tenant_runtime_config_pg_store import MetaCommentSyncCursorRow
