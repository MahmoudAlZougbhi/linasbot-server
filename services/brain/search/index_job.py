...
from services.brain.providers.spaces import ENTITY_DOCUMENT, ENTITY_MODEL, KNOWLEDGE_MODEL
from services.brain.providers.voyage_client import VoyageContractError, embed_texts
...
async def embed_document_rows_incremental(
    ...
    *,
    ...
    from services.brain.search.reuse_vectors import lookup_prior_vectors, merge_prior_and_fresh
...
async def _index_published_body(tid: str, *, revision: str, session: Any | None, activate: bool) -> dict[str, Any]:
    ...
    if not voyage_configured():
        ...
        from services.brain.search.index_lifecycle import mark_failed
...
async def _persist_candidate_and_maybe_activate(
    ...
    *,
    ...
    from services.brain.compiler.chunks import CONTEXTUALIZATION_VERSION
    from services.brain.search.contextual_index import CHUNKER_VERSION, build_and_activate_contextual_index
    from services.brain.search.index_lifecycle import mark_active, mark_candidate_ready, mark_failed
    from services.brain.search.index_validate import candidate_is_activatable
    ...
    from services.brain.providers.spaces import KNOWLEDGE_DOCUMENT
