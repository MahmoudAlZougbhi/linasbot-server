...
from services.brain.search.store import mark_pointer_not_ready
...
def notify_product_change(session: Any | None, tenant_id: str) -> None:
    ...
    try:
        ...
        from services.brain.search.index_lifecycle import mark_stale_durable
        from services.brain.search.index_schedule import enqueue_tenant_index, run_tenant_index_job
