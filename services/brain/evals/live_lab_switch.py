...
from services.brain.search.contextual_index import build_and_activate_contextual_index
from services.brain.search.store import activate_pointer, query_similar, rollback_pointer
