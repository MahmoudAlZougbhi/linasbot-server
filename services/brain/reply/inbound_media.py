...
from services.brain.reply.inbound_fetch import fetch_inbound_url, link_host, max_bytes_for_kind
...
async def _ingest_video(
    *,
    ...
    if not blob:
        ...
        return
    from services.brain.reply.inbound_media_enrich import enrich_inbound_video
