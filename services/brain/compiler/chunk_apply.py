"""Save-time chunks: rewrite on change, keep on unchanged, delete removed items."""

from __future__ import annotations

from typing import Any

from services.ai_setup.search_metadata.fingerprint import content_fingerprint, item_id_of
from services.ai_setup.search_metadata.limits import ITEM_LIST_KEYS
from services.brain.compiler.chunk_store import (
    delete_chunks,
    delete_missing,
    read_chunks,
    write_chunks,
)
from services.brain.compiler.luna_chunker import luna_chunk_prose
from services.brain.compiler.prose import (
    LARGE_TEXT_SECTIONS,
    POLICY_ITEM_ID,
    SECTION_ITEM_ID,
    extract_prose,
