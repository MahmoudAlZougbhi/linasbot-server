"""Which AI Setup fields are large free text that should be chunked on Save."""

from __future__ import annotations

from typing import Any

# Knowledge/care files with a body/notes are always chunked on first save.
...
def needs_luna_chunks(section: str, raw: dict[str, Any] | None) -> bool:
    ...
    if name in ALWAYS_CHUNK_SECTIONS:
        # Titles/short labels alone are not chunked; a body or notes must exist.
        return bool(_text(item.get("body")) or _text(item.get("notes")))
