...
async def text_handlers_respond_phase1(ctx: dict) -> Any:
    ...
    if user_image_base64:
        from services.ai_setup.ai_limits_enforcement import customer_image_limit_message, enforce_image_analysis_quota
    ...
    if user_input_to_process and not tenant_uses_cm_runtime(cm_tenant_id):
        from services.ai_setup.ai_limits_enforcement import apply_inbound_word_limit
