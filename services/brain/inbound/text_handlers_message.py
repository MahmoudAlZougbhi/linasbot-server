...
# services/brain/inbound/text_handlers_message.py
...
# cannot both read the same _text_turn_epoch and schedule two waves with the same epoch.
...
async def handle_message(
    ...
    # Greeting wording is Terra (greeting_turn). Inbound only records eligibility.
