...
async def trigger_human_takeover(
    *,
    ...
    try:
        from services.live_chat.human_takeover_notification_service import human_takeover_notification_service
                        ...
                        if user_data.get("_dashboard_test_simulation"):
                            ...
                            if operator_id:
                                ...
                                if not user_data.get("notified_human_takeover"):
                                    from services.live_chat.takeover_customer_notice import (
