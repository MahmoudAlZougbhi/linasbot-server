...
class ConversationFeedbackService:
    ...
    def __init__(self) -> None:
        self.feedback_log: list[dict[str, Any]] = []  # In-memory log (could be moved to database)
    ...
    async def submit_feedback(
        ...
        try:
            ...
            if feedback_type == "wrong" and correct_answer:
                print("🎓 Training bot with correct answer...")
    ...
    async def train_from_feedback(
        self, user_question: str, correct_answer: str, language: str = "ar", category: str = "feedback_trained"
    ) -> dict:
        """
        ...
        try:
            ...
            if result.get("success"):
                ...
                return {"success": True, "qa_id": qa_id, "message": "Bot trained with new Q&A pair"}
            else:
    ...
    async def train_from_feedback_multilang(
        self, user_question: str, correct_answer: str, source_language: str = "ar", category: str = "operator_trained"
    ) -> dict:
        """
        ...
        try:
            ...
            qa_data = {
                ...
                "question_franco": translations.get("franco", {}).get(
                    "question", user_question if norm_source == "franco" else ""
                ),
            ...
            if not qa_data["question_ar"] and not qa_data["question_en"]:
                return {
                    "success": False,
                    "error": "Could not produce Arabic question for FAQ (ar section must be Arabic script)",
                }
            ...
            if result.get("success"):
                ...
                return {"success": True, "qa_id": qa_id, "message": "Saved to FAQ in 4 languages"}
    ...
    def get_feedback_stats(self) -> dict:
        ...
        if not self.feedback_log:
            return {"total_feedback": 0, "good": 0, "wrong": 0, "inappropriate": 0, "unclear": 0, "trained_count": 0}
    ...
    def get_wrong_answers(self, limit: int = 20) -> list[dict]:
        ...
        """
        wrong_answers = [f for f in self.feedback_log if f["feedback_type"] == "wrong"]
