...
async def try_claim_ai_turn(
    ...
    *,
    ...
    from services.brain.ai_reply.ai_reply_turn_runtime import pending_delivery_for_claim
    ...
    if await _legacy_ai_turn_claim_exists(key_basis):
        ...
        return False
    from services.scale.durable_event_claim import meta_claim_binding_digest, renew_event_claim, try_claim_event_handle
...
async def release_ai_turn_claim(key_basis: str) -> None:
    ...
    from services.scale.durable_event_claim import release_event_claim
