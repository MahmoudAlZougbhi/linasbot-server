...
def recommend(
    *,
    ...
    backlog_growing = ingress_per_sec > complete_per_sec + 0.5 and queue_depth > 0
    api_hot = (
    ...
    mild = wait_p95_ms >= p95_up or oldest_age_seconds >= oldest_up or backlog_growing or api_hot
