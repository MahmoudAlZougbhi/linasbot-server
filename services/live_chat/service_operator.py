...
from services.live_chat.operator_pause_session import (
...
class LiveChatOperatorMixin:
    ...
    async def send_operator_message(
        ...
        try:
            ...
            from services.live_chat.operator_social_delivery import is_social_live_chat_user
            from services.live_chat.operator_text_delivery import (
            ...
            if message_type == "voice":
                from services.live_chat.operator_media_handlers import send_operator_voice_message
                ...
                from services.live_chat.operator_media_handlers import send_operator_image_message
                ...
                from services.live_chat.operator_delivery_status import (
