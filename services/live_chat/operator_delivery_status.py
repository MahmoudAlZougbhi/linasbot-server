...
from services.live_chat.operator_pause_session import operator_thread_status
...
async def notify_live_chat_operator_job(
    ...
    *,
    ...
    if delivery_status == "failed" and client_id:
        from services.live_chat.service_common import release_operator_send_idempotency
