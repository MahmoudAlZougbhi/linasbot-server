...
from services.live_chat.channel import is_web_live_chat_user, resolve_live_chat_channel
...
from services.live_chat.tiktok_operator import is_tiktok_live_chat_user, tiktok_operator_media_not_supported
...
async def deliver_saved_operator_text(
    *,
    ...
    if is_social_live_chat_user(user_id):
        from services.live_chat.operator_social_delivery import deliver_social_operator_text
