...
class MessageSyncService:
    ...
    async def incremental_sync(self) -> Any:
        ...
        try:
            ...
            logger.info(
                f"✅ Sync complete: {new_count} new, {updated_count} updated, {unchanged_count} unchanged, {failed_count} failed"
            )
    ...
    async def detect_deletions(self) -> Any:
    ...
    async def full_resync(self) -> Any:
    ...
    async def _generate_messages_for_appointment(self, appointment: Any) -> Any:
    ...
    def _parse_appointment_date(self, date_str: Any) -> Any:
    ...
    async def _fetch_appointments(self) -> Any:
    ...
    async def _fetch_all_appointment_ids(self) -> Any:
