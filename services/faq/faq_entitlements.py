...
Source of truth: ``services.billing.membership.message_catalog`` via ``faq_limits_for_plan``.
...
from services.billing.membership.feature_entitlements import faq_limits_for_plan
