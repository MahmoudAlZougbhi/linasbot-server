...
SECTION_GUIDE: dict[str, dict[str, Any]] = {
    ...
    "ai_limits": {
        "title": "AI Limits",
        "purpose": "Per-customer image/context usage caps and AI capability switches.",
        "why": "Protects cost and abuse once Live.",
        "what_to_fill": [
            "image_per_day/week",
            "context_lines_per_day/week",
            "enforce_* flags",
            "human_handoff_enabled",
            "voice_processing_enabled",
            "image_analysis_enabled",
        ],
        "useful": "Human handoff, photo analysis, voice processing, and usage limits in one place.",
        "app_path": "Settings → AI Limits (mobile)",
    },
    "off_days": {
        "title": "Off Days",
