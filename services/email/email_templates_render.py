...
from services.dashboard.platform_portal_hosts import EMAIL_LINK_HOSTS
from services.email.email_templates_catalog import get_template_copy, normalize_locale
