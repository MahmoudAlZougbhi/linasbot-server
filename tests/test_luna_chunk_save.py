"""Luna chunks large owner text on Save; edit replaces old chunks and embeddings."""
...
from services.customer_ai.compiler.chunk_store import chunk_path, chunk_texts, read_chunks
from services.customer_ai.compiler.luna_chunker import reset_chunk_generator, set_chunk_generator
from services.customer_ai.retrieve.cards import TitleCard, cards_from_sections
from services.customer_ai.search.contextual_index import build_contextual_rows
from services.customer_ai.search.index_job import document_rows
from services.search_metadata.chunk_apply import last_chunk_apply_stats
...
def test_long_greeting_and_ai_basics_are_chunked(tmp_path, monkeypatch) -> None:
    ...
    from services.customer_ai.compiler.prose import SECTION_ITEM_ID
...
def test_luna_chunk_fail_closed_on_save(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("services.customer_ai.compiler.luna_chunker._llm_enabled", lambda: True)
    monkeypatch.setattr("services.customer_ai.compiler.luna_chunker._luna_chunks", _boom)
