...
def test_parse_accepts_unknown_id_when_sole_row_has_dm_fields_on_account_scoped_read(instagram_env: None) -> None:
    ig_user_id = "17841413184256533"
    snapshot = parse_subscription_snapshot(
        {
            "data": [
...
def test_parse_rejects_unknown_id_when_sole_row_lacks_dm_fields(instagram_env: None) -> None:
    ig_user_id = "17841413184256533"
    assert (
        parse_subscription_snapshot(
            {
