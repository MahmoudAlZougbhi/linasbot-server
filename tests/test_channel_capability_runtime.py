...
def test_unpublished_tenant_keeps_dm_replies_on(monkeypatch) -> None:
    monkeypatch.setattr("services.integrations.channel_capability_runtime.load_actions_section", lambda _tenant: None)
...
async def test_enable_comments_ensures_comment_webhooks(monkeypatch) -> None:
    ...
    monkeypatch.setattr("services.integrations.channel_capability_toggles._publish_actions", AsyncMock())
    monkeypatch.setattr(
