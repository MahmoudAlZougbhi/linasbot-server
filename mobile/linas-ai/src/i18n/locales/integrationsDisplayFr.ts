...
export const integrationsDisplayFr = {
  ...
  tiktokEnhancedVideoContext: 'Contexte vidéo amélioré',
  tiktokEnhancedEnable: 'Activer le contexte vidéo amélioré',
  tiktokEnhancedWaiting: 'En attente de l’approbation TikTok',
  tiktokEnhancedAuthRequired: 'Autorisation requise',
  tiktokEnhancedIdentityRequired: 'Autorisation d’identité requise',
  tiktokEnhancedReauth: 'Réautorisation requise',
  tiktokEnhancedActive: 'Actif',
  tiktokEnhancedLimited: 'Limité par TikTok',
