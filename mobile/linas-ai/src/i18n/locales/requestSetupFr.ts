...
export const requestSetupFr: Record<keyof typeof requestSetupEn, string> = {
  ...
  requestRulesScope: 'Portée',
  requestRulesScopeGeneral: 'Général',
  requestRulesScopeAllServices: 'Tous les services',
  requestRulesScopeService: 'Un service',
  requestRulesScopeAllProducts: 'Tous les produits',
  requestRulesScopeProduct: 'Un produit',
  requestRulesScopeHandoff: 'Transfert',
  requestRulesEntityIds: 'Identifiants',
  requestRulesEntityIdsHint: 'IDs de service ou produit séparés par des virgules',
  requestRulesTrigger: 'Quand appliquer',
  requestRulesTriggerInquiry: 'Question',
  requestRulesTriggerAction: 'Action',
  requestRulesConfirmOn: 'Confirmation client requise',
  requestRulesConfirmOff: 'Pas d’étape de confirmation',
