...
export const requestSetupAr: Record<keyof typeof requestSetupEn, string> = {
  ...
  requestRulesScope: 'النطاق',
  requestRulesScopeGeneral: 'عام',
  requestRulesScopeAllServices: 'كل الخدمات',
  requestRulesScopeService: 'خدمة محددة',
  requestRulesScopeAllProducts: 'كل المنتجات',
  requestRulesScopeProduct: 'منتج محدد',
  requestRulesScopeHandoff: 'تحويل لموظف',
  requestRulesEntityIds: 'معرفات العناصر',
  requestRulesEntityIdsHint: 'معرفات الخدمات أو المنتجات مفصولة بفاصلة',
  requestRulesTrigger: 'متى تُطبَّق',
  requestRulesTriggerInquiry: 'سؤال',
  requestRulesTriggerAction: 'إجراء',
  requestRulesConfirmOn: 'يلزم تأكيد الزبون',
  requestRulesConfirmOff: 'بدون خطوة تأكيد إضافية',
