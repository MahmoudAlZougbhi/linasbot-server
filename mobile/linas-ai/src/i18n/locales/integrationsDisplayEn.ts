...
export const integrationsDisplayEn = {
  ...
  tiktokEnhancedVideoContext: 'Enhanced Video Context',
  tiktokEnhancedEnable: 'Enable Enhanced Video Context',
  tiktokEnhancedWaiting: 'Waiting for TikTok approval',
  tiktokEnhancedAuthRequired: 'Authorization required',
  tiktokEnhancedIdentityRequired: 'Identity authorization required',
  tiktokEnhancedReauth: 'Reauthorization required',
  tiktokEnhancedActive: 'Active',
  tiktokEnhancedLimited: 'Limited by TikTok',
