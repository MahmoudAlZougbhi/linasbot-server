...
export const integrationsDisplayAr = {
  ...
  tiktokEnhancedVideoContext: 'سياق الفيديو المحسّن',
  tiktokEnhancedEnable: 'تفعيل سياق الفيديو المحسّن',
  tiktokEnhancedWaiting: 'بانتظار موافقة TikTok',
  tiktokEnhancedAuthRequired: 'يلزم التفويض',
  tiktokEnhancedIdentityRequired: 'يلزم تفويض الهوية',
  tiktokEnhancedReauth: 'يلزم إعادة التفويض',
  tiktokEnhancedActive: 'فعّال',
  tiktokEnhancedLimited: 'محدود من TikTok',
