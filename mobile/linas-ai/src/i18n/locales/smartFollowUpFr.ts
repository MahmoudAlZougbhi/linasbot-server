export const smartFollowUpFr = {
  ...
  sfuSubtitle: 'Relancez automatiquement quand un client WhatsApp cesse de répondre.',
  ...
  sfuBusinessHours: 'Uniquement pendant les heures d’ouverture',
  sfuBusinessHoursHint: 'Ne pas envoyer hors des heures publiées (activé par défaut).',
  sfuAiWrites: 'L’IA rédige chaque message',
  sfuAiWritesBody:
    'Chaque relance est écrite par l’IA de réponse client pour cette conversation — pas un modèle fixe ni une campagne marketing.',
