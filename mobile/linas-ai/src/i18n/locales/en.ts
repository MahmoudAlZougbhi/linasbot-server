export const en = {
  ...
  composerPlaceholder: 'Message Linas',
  ...
  settingsBusinessProfileSub: 'Update business facts in Content Management',
  settingsBusinessProfileNote: 'Open Content Management → AI Basics',
