...
export const en = {
  ...
  chatLeftoverCreditsPausedTitle: 'Not enough leftover credits',
  chatLeftoverCreditsPausedBody:
    'Owner Copilot is paused until you add leftover credits. Channel AI replies are paused too.',
  chatAddLeftoverCredits: 'Add leftover credits',
  chatYouLabel: 'You',
  ...
  linEffortCostsMore: 'Uses more messages',
  settings: 'Settings',
  ...
  settingsAiLimitsSub: 'Protect messages by limiting each customer’s AI usage',
  faqTitle: 'Smart Q&A',
  ...
  faqCreateHint:
    'Write the question and answer in one language. We auto-translate to Arabic, English, French, and Franco. Matching customer questions reply from FAQ instead of a full AI generation — that uses 0 AI messages.',
  faqSaved: 'Saved in 4 languages.',
  faqLoadError: 'Could not load FAQ.',
  faqCreateError: 'Could not create FAQ.',
  faqWhyTitle: 'Smart Q&A uses 0 messages',
  faqWhyBody:
