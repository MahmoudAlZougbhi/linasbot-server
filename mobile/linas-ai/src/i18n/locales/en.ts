...
export const en = {
  ...
  chatAddLeftoverCredits: 'Buy messages',
  chatBillingConfirmTitle: 'This uses messages',
  chatBillingConfirmBody: 'This action will use {n} messages.',
  chatBillingConfirmCta: 'Use messages and continue',
  chatYouLabel: 'You',
