export const en = {
  ...
  commentsBlockerMissingPermissions:
    'Comments need Meta comment permissions. Use Manage permissions / Reauthorize with comment access (do not Disconnect).',
  ...
  manageCommentPermissions: 'Manage permissions',
  reconnectWithCommentAccess: 'Reconnect with comment access',
  commentsStatusReady: 'Comments status: Ready (not live verified)',
  commentsStatusLiveVerified: 'Comments status: Live Verified',
  commentsStatusReadyToEnable: 'Comments status: permissions ready — toggle to enable',
  commentsStatusNeedsWebhook: 'Comments status: needs webhook subscription',
  commentsStatusNeedsPermission: 'Comments status: missing Meta comment permissions',
  testConnectionReadOnly: 'Test connection (read-only refresh)',
  testConnectionReadOnlyHint:
    'App A only. Test connection reloads verified state from the backend — it does not grant permissions, reconnect, change webhooks, subscriptions, or credentials.',
