...
export const ar = {
  ...
  chatAddLeftoverCredits: 'شراء رسائل',
  chatBillingConfirmTitle: 'هالخطوة بتستخدم رسائل',
  chatBillingConfirmBody: 'هالخطوة رح تستخدم {n} رسائل.',
  chatBillingConfirmCta: 'استخدم الرسائل وكمّل',
  chatYouLabel: 'أنت',
