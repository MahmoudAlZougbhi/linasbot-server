...
export const ar = {
  ...
  chatLeftoverCreditsPausedTitle: 'ما في رصيد متبقٍ كافٍ',
  chatLeftoverCreditsPausedBody:
    'مساعد المالك متوقف إلى أن تضيف الرصيد المتبقي. ردود الذكاء الاصطناعي على القنوات متوقفة أيضاً.',
  chatAddLeftoverCredits: 'إضافة الرصيد المتبقي',
  chatYouLabel: 'أنت',
  ...
  linEffortCostsMore: 'تستخدم رسائل أكثر',
  settings: 'الإعدادات',
  ...
  groupAccount: 'الحساب',
  groupOwner: 'المنصة',
  smartAnswers: 'الأسئلة والأجوبة',
  faqQuota: 'حصة الأسئلة الشائعة',
  faqQuotaUpgrade: 'تم بلوغ حد الأسئلة والأجوبة. قم بترقية خطتك لحد أعلى.',
  likeFaqAction: 'إعجاب',
  ...
  settingsAiLimits: 'حدود الذكاء الاصطناعي للزبائن',
  settingsAiLimitsSub: 'احمِ الرسائل بتحديد استخدام كل زبون للذكاء الاصطناعي',
  faqTitle: 'الأسئلة والأجوبة',
  faqSub: 'ترجم الأسئلة والأجوبة لأي لغة تختارها.',
  faqCreateNew: 'إنشاء سؤال وجواب',
  faqSavedList: 'الأسئلة والأجوبة المحفوظة',
  faqEmpty: 'لا توجد أسئلة وأجوبة بعد.',
  faqCreateHint:
    'اكتب السؤال والجواب بلغة واحدة. نترجم تلقائياً إلى العربية والإنجليزية والفرنسية والفرانكو. عندما يسأل الزبون نفس السؤال أو نفس المعنى، الرد من الأسئلة الشائعة بدل توليد ذكاء اصطناعي كامل — وهذا ما بيستهلك رسائل ذكاء.',
  faqSaved: 'تم الحفظ بأربع لغات.',
  faqLoadError: 'تعذر تحميل الأسئلة الشائعة.',
  faqCreateError: 'تعذر إنشاء السؤال.',
  faqWhyTitle: 'الأسئلة والأجوبة ما بتستهلك رسائل',
  faqWhyBody:
  ...
  composerPlaceholder: 'دردش مع Linas',
  composerPlaceholderChat: 'دردش مع Linas',
  composerPlaceholderWork: 'اعمل مع Linas',
