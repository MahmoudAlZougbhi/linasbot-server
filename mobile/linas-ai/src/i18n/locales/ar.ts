...
export const ar = {
  ...
  settingsBusinessProfileSub: 'حدّث معلومات البزنس من إدارة المحتوى',
  settingsBusinessProfileNote: 'افتح إدارة المحتوى → أساسيات الذكاء',
  ...
  navContentManagement: 'إدارة المحتوى',
