...
export const ar: Record<StringKey, string> = {
  ...
  commentsBlockerMissingPermissions:
    'التعليقات تحتاج صلاحيات Meta للتعليقات. استخدم إدارة الصلاحيات / إعادة التفويض مع صلاحية التعليقات (بدون فصل).',
  ...
  manageCommentPermissions: 'إدارة الصلاحيات',
  reconnectWithCommentAccess: 'إعادة الربط مع صلاحية التعليقات',
  commentsStatusReady: 'حالة التعليقات: جاهز (غير مثبت مباشرة)',
  commentsStatusLiveVerified: 'حالة التعليقات: مثبت مباشرة',
  commentsStatusReadyToEnable: 'حالة التعليقات: الصلاحيات جاهزة — فعّل المفتاح',
  commentsStatusNeedsWebhook: 'حالة التعليقات: يحتاج اشتراك ويبهوك',
  commentsStatusNeedsPermission: 'حالة التعليقات: صلاحيات تعليق Meta ناقصة',
  testConnectionReadOnly: 'اختبار الاتصال (تحديث للقراءة فقط)',
  testConnectionReadOnlyHint:
    'App A فقط. اختبار الاتصال يعيد تحميل الحالة من الخادم — لا يمنح صلاحيات ولا يغيّر الاشتراكات أو بيانات الاعتماد.',
