...
export const fr: Record<StringKey, string> = {
  ...
  composerPlaceholder: 'Message à Linas',
  ...
  settingsBusinessProfileSub: 'Mettre à jour les faits métier dans Content Management',
  settingsBusinessProfileNote: 'Ouvrir Content Management → Bases IA',
