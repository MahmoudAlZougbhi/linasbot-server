...
export const fr = {
  ...
  linEffortCostsMore: 'Utilise plus de messages',
  settings: 'Paramètres',
  ...
  platformWeb: 'Chat sur le site web',
  ...
  settingsAiLimitsSub: 'Protégez les messages en limitant l’usage IA de chaque client',
  ...
  faqCreateHint:
    'Écrivez la question et la réponse dans une langue. Traduction auto vers arabe, anglais, français et franco. Quand un client pose la même question (ou le même sens), la FAQ répond à la place d’une génération IA complète — cela utilise 0 message IA.',
  faqSaved: 'Enregistré en 4 langues.',
  faqLoadError: 'Impossible de charger la FAQ.',
  faqCreateError: 'Impossible de créer la FAQ.',
  faqWhyTitle: 'Les Q&R intelligentes utilisent 0 message',
  faqWhyBody:
