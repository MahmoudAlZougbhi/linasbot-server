...
export const AI_SETUP_MISSING_BG = '#FFF4EB';
export const AI_SETUP_MISSING_BORDER = '#F5DCC8';
export const AI_SETUP_PROGRESS_TRACK = '#E5EBEA';
export const AI_SETUP_CARD_BORDER = '#E8EDEC';
