...
export const KN_MUTED = '#94A3B8';
export const KN_TEXT = '#0F3D3A';
export const KN_CANVAS = '#F7F8F8';
export const KN_RADIUS = 12;
export const KN_RADIUS_SM = 8;
export const KN_ICON_SQ = 44;
export const KN_PDF = '#E11D48';
export const KN_DOT = '#107C75';
