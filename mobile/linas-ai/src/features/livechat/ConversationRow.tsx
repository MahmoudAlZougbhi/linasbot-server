...
import { InboxRowDivider } from './InboxRowDivider';
...
export function ConversationRow({ item, onPress, showDivider = true }: Props) {
  ...
  return (
    ...
    >
      ...
      {showDivider ? <InboxRowDivider color={colors.textDim} /> : null}
    </Pressable>
  );
}
