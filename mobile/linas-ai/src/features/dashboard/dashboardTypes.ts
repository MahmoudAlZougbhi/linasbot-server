...
export const TenantDashboardSchema = z.object({
  ...
  plan_and_credits: z
    .object({
      ...
      message_billing_active: z.boolean().optional(),
      included_messages: z.number().nullable().optional(),
      purchased_messages: z.number().nullable().optional(),
      reserved_messages: z.number().nullable().optional(),
      available_messages: z.number().nullable().optional(),
