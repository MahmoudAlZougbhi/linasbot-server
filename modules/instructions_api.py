...
from storage.persistent_storage import CONTENT_DIR, STYLE_GUIDE_FILE, ensure_dirs
...
async def get_instructions() -> Any:
    ...
    try:
        ...
        if not os.path.exists(instructions_path):
            return {"success": False, "error": "Instructions file not found"}
...
async def update_instructions(request: dict) -> Any:
    ...
    try:
        ...
        print("✅ Bot instructions updated and reloaded into memory")
...
async def restore_backup(request: dict) -> Any:
