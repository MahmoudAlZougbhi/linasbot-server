"""Public TikTok Marketing OAuth callback — tenant comes only from signed one-time state."""
...
async def tiktok_ads_oauth_callback(request: Request) -> Any:
    ...
    try:
        result = await complete_tiktok_ads_oauth(
            state=state,
            code=code,
            error=error,
        ...
        html = (
            ...
            "<p>Enhanced Video Context did not complete. Open the Linas AI app and try again from Integrations.</p>"
